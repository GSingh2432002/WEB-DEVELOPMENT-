...
const root = document.documentElement.Styles;
...
function updateProfile(data) {
    if(data.message !== "Not Found") {
        noresults.Styles.display = "none";
        function checkNull(param1, param2) {
            if(param1 === "" || param1 === null) {
                param2.Styles.opacity = 0.5;
                param2.previousElementSibling.Styles.opacity = 0.5;
                return false;
            } else{
                return true;
            }
        ...
        noresults.Styles.display = "block";
    }
}
